...
class SellKontrol {
    ...
    async SellYaptiBuyYap(position, quantity, fazlaAlimVar){
        ...
        await this.CreateOrder('sell', this.amount * 2, position.sells[0].Price + this.ikinciIslemFark * 20) // 5. işlem 30 katı aşşa insin yani 105 dolar
    }
    ...
    async BuyYaptiSellYap(position, quantity, fazlaAlimVar){
        ...
        await this.CreateOrder('buy', this.amount * 2, position.buys[0].Price - this.ikinciIslemFark * 20 ) // 5. işlem 30 katı aşşa insin yani 105 dolar
    }
